  ...
  try {
    ...
    const medications = [
      // Prescriptions
      {
        ...
        active: true,
        interactions: 'Beta-blocker. Avoid decongestants. Impairs thermoregulation in heat.',
        kidney_safe: true,
      ...
      },
      {
        ...
        active: true,
        interactions: 'ARB. NEVER combine with potassium supplements (hyperkalemia risk). NSAIDs reduce effectiveness.',
        kidney_safe: true,
      ...
      },
      {
        ...
        active: true,
        interactions: 'Statin. NEVER combine with grapefruit. Depletes CoQ10 (supplement required). Monitor liver enzymes.',
        kidney_safe: true,
      ...
      },
      {
        ...
        active: true,
        interactions: 'PCSK9 inhibitor. Self-administered subcutaneous injection. Rotate injection sites.',
        kidney_safe: true,
      ...
      },
      {
        ...
        active: true,
        interactions: 'Antiplatelet. Avoid high-dose Vitamin E (bleeding risk). Take with food (GI protection).',
        kidney_safe: true,
      ...
      // Supplements
      {
        ...
        active: true,
        interactions: 'Fat-soluble. Take with food. Choose pharmaceutical-grade with third-party testing.',
        kidney_safe: true,
      ...
      },
      {
        ...
        active: true,
        interactions: 'Fat-soluble. Take with food. Ubiquinol is the active form (preferred over ubiquinone).',
        kidney_safe: true,
      ...
      },
      {
        ...
        active: true,
        interactions: 'Glycinate form preferred over oxide (better absorption, no GI upset).',
        kidney_safe: true,
      ...
      },
      {
        ...
        active: true,
        interactions: 'Fat-soluble. Take with food. Dose based on lab results (pending baseline 25-OH Vitamin D test).',
        kidney_safe: true,
