...
export default function AppShell({ userEmail, children }: AppShellProps) {
  ...
  return (
    <div className="min-h-screen md:flex">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-72 transform transition-transform md:static md:w-64 md:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
        <Sidebar userEmail={userEmail} isOpen={sidebarOpen || undefined} onClose={() => setSidebarOpen(false)} />
      </div>
