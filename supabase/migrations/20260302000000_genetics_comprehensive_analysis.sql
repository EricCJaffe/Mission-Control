-- Genetics Comprehensive Analysis
-- Stores the cross-report rolled-up AI analysis synthesizing all genetic reports
...
-- RPC: Upsert comprehensive analysis (one row per user)
